...
//  给Extension添加存储属性
//
//  Created by mfang032 on 2017/5/4.
...
//        
//        set(newColor) {
//            objc_setAssociatedObject(self, &key, newColor, objc_AssociationPolicy.OBJC_ASSOCIATION_RETAIN_NONATOMIC)
...
//        
//        set(newBorderWidth) {
//            objc_setAssociatedObject(self, &key, newBorderWidth, objc_AssociationPolicy.OBJC_ASSOCIATION_RETAIN_NONATOMIC)
//            layer.borderWidth = newBorderWidth ?? 0
//        }
//    }
//    
